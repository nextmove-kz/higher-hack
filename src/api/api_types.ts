...
export type CompanyResponse<Texpand = unknown> = Required<CompanyRecord> &
  BaseSystemFields<Texpand>;
export type ExperienceResponse<Texpand = unknown> = Required<ExperienceRecord> &
  BaseSystemFields<Texpand>;
export type ResponseResponse<Texpand = unknown> = Required<ResponseRecord> &
  BaseSystemFields<Texpand>;
export type ResumeResponse<Texpand = unknown> = Required<ResumeRecord> &
  BaseSystemFields<Texpand>;
export type UsersResponse<Texpand = unknown> = Required<UsersRecord> &
  AuthSystemFields<Texpand>;
export type VacancyResponse<Texpand = unknown> = Required<VacancyRecord> &
  BaseSystemFields<Texpand>;
